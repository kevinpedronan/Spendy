package com.kevinpedronan.spendy; //Replace this with your package name
...
public class VenmoWebViewActivity extends Activity {
	...
	//Is it okay to surpress this warning?
	...
	public void onCreate(Bundle icicle) {
    	...
    	if(mVenmoWebView != null) { //If screen was rotated, don't reload the whole webview
    		...
    		//This produces and error something about API level 17 (below Jelly Bean)
